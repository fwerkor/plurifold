...
Mosaic therefore does not expose WAN links as fake shared memory and does not silently construct global collectives. RTT, bandwidth, data locality, startup cost, and resource reliability are scheduler inputs.
